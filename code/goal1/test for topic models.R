...
atmosphere_alcohol=c(707.8647, 821.4149, 1499.0914, 4243.4561, 8652.448)
not_atmosphere = total_count-atmosphere_alcohol
chisq.test(atmosphere_alcohol, p=not_atmosphere, rescale.p = TRUE)
...
(sixthtable=data.frame(star1,star2,star3,star4,star5,row.names = c("atmosphere_alcohol","not_atmosphere")))
...
niceservice=nice_service_amazing_atmosphere/total_count
cor.test(atmosphere,niceservice,method="spearman")

Mexicanfood=Mexican_food/total_count
cor.test(coffeetea,Mexicanfood,method="spearman")

happyhour=bruschetta_bar_happy_hour/total_count
cor.test(happyhour,niceservice,method="spearman")  # p-value = 0.08333
